...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CharPageControl/CharPageControl.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SESlideTableViewCell/SESlideTableViewCell.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Signals/Signals.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SwiftyJSON/SwiftyJSON.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ZTDropDownTextField/ZTDropDownTextField.framework"
